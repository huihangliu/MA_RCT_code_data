...
settings <- list(n=c(50, 100, 150, 200), alpha=c(0.5, 1, 1.5), rho=c(0, 0.5))
settings <- cross3(settings$n, settings$alpha, settings$rho, .filter = NULL)
...
sfLapply(c(1:(length(settings))), main_parallel)
sfStop()
